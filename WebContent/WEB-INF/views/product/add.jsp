...
<div class="easyui-panel" title="添加商品" style="width:1200px;height:800px;">
		...
		<form id="add-form" method="post">
	        <table cellspacing="15">
	            <tr>
	                ...
	                <td >
	                	<select name="productCategoryId" idField="id" treeField="name" class="easyui-combotree easyui-validatebox" data-options="required:true, missingMessage:'请选择所属分类'" url="tree_list" panelHeight="256px" style="width:268px">
			            </select>	
	                </td>
	            </tr>
	            <tr>
	                <td width="60" align="right">商品标题:</td>
	                <td ><input type="text" name="name" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写商品标题'" /></td>
	            </tr>
	            <tr>
	                <td width="60" align="right">商品主图:</td>
	                <td>
	                	<input readonly="readonly" type="text" id="add-imageUrl" name="imageUrl" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请上传图片'" />
	            ...
	            <tr>
	                ...
	                <td ><input type="text" name="stock" class="wu-text easyui-numberbox easyui-validatebox" data-options="required:true,min:0,precision:0, missingMessage:'请填写商品库存'" /></td>
	            </tr>
	            <tr>
	                <td align="right">详情描述:</td>
	                <td style="border:0px;"><textarea id="add-content" name="content" style="width:600px;height:320px;"></textarea></td>
	            </tr>
	            <tr>
	                <td align="right"></td>
	                <td style="border:0px;">
